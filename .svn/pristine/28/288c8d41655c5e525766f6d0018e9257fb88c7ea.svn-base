...
class es_cls_widget {
	public static function load_subscription($arr) {
		...
		$es .= '<div class="sectionInfo"><div class="row">';
		...
		$es .= '<div class="es_textbox col-sm-7">';
			$es .= '<input type="text" id="es_txt_email_pg" class="es_textbox_class formInput formInput100 bannerInput" placeholder="Youe Email Address" name="es_txt_email_pg" onkeypress="if(event.keyCode==13) es_submit_pages(event, '.$url.')" value="" maxlength="225">';
		$es .= '</div>';
		$es .= '<div class="col-sm-3"><div class="es_button sButton">';
			$es .= '<input type="button" id="es_txt_button_pg" class="es_textbox_button formButton es_submit_button" name="es_txt_button_pg" onClick="return es_submit_pages(event, '.$url.')" value="'.__( 'Subscribe', ES_TDOMAIN ).'">';
		$es .= '</div></div>';
